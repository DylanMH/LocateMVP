 ...
 *
 * In development (expo start), the app points to the OVH server by default
 * so you can test without running the backend locally. To use a local
 * backend instead, set EXPO_PUBLIC_API_URL in Locate720/.env.local:
 ...
 */
const DEV_API_URL =
  process.env.EXPO_PUBLIC_API_URL || 'http://15.204.247.173:3000/api';
